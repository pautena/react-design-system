import{r as v,a as C,j as b,b as k,m as u,n as c}from"./iframe-DF1-CE8W.js";import{a as w,g as x,c as R}from"./generateUtilityClasses-ep8tZ6E9.js";import{s as S,a as $,m as U}from"./memoTheme-BiQeu4dL.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return w("MuiSkeleton",t)}x("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return $({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
