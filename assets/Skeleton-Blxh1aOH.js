import{r as v,b as C,j as b,e as k,m as u,n as c}from"./iframe-BupHDtd1.js";import{s as w,a as x,m as R}from"./memoTheme-uoO9vclW.js";import{a as S,g as $}from"./generateUtilityClasses-CoM_PQv9.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return S("MuiSkeleton",t)}$("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return x({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},A,e)},r=c`
  0% {
    opacity: 1;
  }
