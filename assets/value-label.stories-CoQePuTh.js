import{w as re}from"./storybook-BhLlBB8C.js";import{j as g}from"./jsx-runtime-D_zvdyIk.js";import{L as y}from"./label-be7sxgni.js";import"./value-edit-50wQKCkd.js";import{D as se}from"./value-displays.types-y9Dsh-vS.js";import{g as oe,V as le}from"./value-content-Y_CnBloZ.js";import{G as te}from"./Grid-Ca03CLp9.js";const Y=({label:L,value:r,placeholder:v=se,color:e,variant:a})=>{const Z=oe(L),ee=Array.isArray(r)?r.map((ae,b)=>g.jsx(y,{text:ae.toString()||v,variant:Array.isArray(a)?a[b]:a,color:Array.isArray(e)?e[b]:e},b)):g.jsx(y,{text:(r==null?void 0:r.toString())||v,variant:Array.isArray(a)?a[0]:a,color:Array.isArray(e)?e[0]:e});return g.jsx(le,{label:L,children:g.jsx(te,{container:!0,gap:1,"aria-labelledby":Z,children:ee})})};Y.__docgenInfo={description:"Displays a label component value with a label",methods:[],displayName:"ValueLabel",props:{label:{required:!0,tsType:{name:"string"},description:"Name of the displayed value"},value:{required:!1,tsType:{name:"T"},description:"Value displayed"},placeholder:{required:!1,tsType:{name:"string"},description:"String rendered if value is undefined",defaultValue:{value:'"-"',computed:!1}},dense:{required:!1,tsType:{name:"boolean"},description:`The value has to be displayed as compact or not.
