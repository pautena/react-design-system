import{j as i}from"./iframe-OKrkvHog.js";import{u as r}from"./Drawer.provider-DmtYtpwg.js";import{D as o}from"./DrawerItem-CWDVQcDP.js";import{u as s}from"./useTheme-RQYRicNz.js";import{L as m}from"./List-DxUAfoP3.js";function l({navigation:t}){const{size:n}=r(),{spacing:e}=s();return i.jsx(m,{sx:{paddingTop:n==="small"?e(.5):void 0,paddingX:e(n==="small"?.5:1)},children:t.map(a=>i.jsx(o,{item:a},a.id))})}l.__docgenInfo={description:"Content to be shown inside a navigation",methods:[],displayName:"DrawerContent",props:{navigation:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| DrawerNavigationLink
