import{j as n}from"./iframe-OKrkvHog.js";import{S as T}from"./storybook-D1oaJzNH.js";import{B as x}from"./BootstrapDialog-DxqLYnV4.js";import{G as u}from"./Grid-DWDS5_i6.js";import{T as f}from"./TextField-NkFzLAue.js";const S=o=>{const i=new FormData(o.currentTarget),r={};return i.forEach((c,e)=>{r[e]=c}),r};function m({open:o,title:i,loading:r,disabled:c,submitText:e="Submit",cancelText:a="Cancel",children:b,onSubmit:h,onCancel:p}){const D=g=>{g.preventDefault(),h(S(g))};return n.jsx(x,{component:"form",componentProps:{onSubmit:D},title:i,loading:r,disabled:r||c,open:o,onClose:p,callCloseWhenCancel:!1,cancelable:!0,acceptable:!0,cancelText:a,onCancel:p,acceptText:e,acceptType:"submit",children:b})}m.__docgenInfo={description:`A generic form dialog component that wraps a BootstrapDialog and handles form submission.
...
>
  {children}
</FormDialog>`}}}},argTypes:{open:{description:"Whether the dialog is open."},title:{description:"The title of the dialog."},loading:{description:"Whether the dialog is in a loading state."},disabled:{description:"Whether the dialog is disabled."},children:{description:"Children to be rendered inside the dialog."}},render:o=>n.jsx(T,{component:m,args:o})},t={args:{open:!0,title:"Lorem ipsum",children:n.jsxs(u,{container:!0,spacing:2,children:[n.jsx(u,{size:12,children:n.jsx(f,{name:"message",label:"Message",fullWidth:!0,required:!0,variant:"outlined"})}),n.jsx(u,{size:12,children:n.jsx(f,{name:"amount",label:"Amount",fullWidth:!0,required:!0,variant:"outlined"})})]})}};t.parameters={docs:{source:{code:`import { useState } from 'react';
