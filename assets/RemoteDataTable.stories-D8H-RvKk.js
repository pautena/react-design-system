...
}`,...J.parameters?.docs?.source},description:{story:`Example using the useRemoteDataTable hook for state management.
This hook aggregates pagination, sorting, and filters state.`,...J.parameters?.docs?.description}}};const ma=["Default","SortedByCreatedDate","WithQueryBuilder","UsingHook"];export{re as Default,ie as SortedByCreatedDate,J as UsingHook,oe as WithQueryBuilder,ma as __namedExportsOrder,pa as default};
