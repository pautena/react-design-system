import{w}from"./storybook-1EOoAo-1.js";import{j as d}from"./iframe-CP7Wc6pw.js";import{L as y}from"./Label-FFbp2zxE.js";import{D as A}from"./ValueDisplays.types-y9Dsh-vS.js";import{g as x,V as T}from"./ValueContent-CQjNptDz.js";import{G as C}from"./Grid-C_earOP1.js";function f({label:L,value:g,placeholder:v=A,color:e,variant:a}){const V=x(L),S=Array.isArray(g)?g.map((h,b)=>d.jsx(y,{text:h.toString()||v,variant:Array.isArray(a)?a[b]:a,color:Array.isArray(e)?e[b]:e},b)):d.jsx(y,{text:g?.toString()||v,variant:Array.isArray(a)?a[0]:a,color:Array.isArray(e)?e[0]:e});return d.jsx(T,{label:L,children:d.jsx(C,{container:!0,gap:1,"aria-labelledby":V,children:S})})}f.__docgenInfo={description:"Displays a label component value with a label",methods:[],displayName:"ValueLabel",props:{label:{required:!0,tsType:{name:"string"},description:"Name of the displayed value"},value:{required:!1,tsType:{name:"T"},description:"Value displayed"},placeholder:{required:!1,tsType:{name:"string"},description:"String rendered if value is undefined",defaultValue:{value:'"-"',computed:!1}},dense:{required:!1,tsType:{name:"boolean"},description:`The value has to be displayed as compact or not.
