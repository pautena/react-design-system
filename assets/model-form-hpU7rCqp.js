import{j as l}from"./jsx-runtime-D_zvdyIk.js";import{r as D}from"./index-MPVjHJeJ.js";import{G as z}from"./group-value-card-CyvGOzjB.js";import{u as O}from"./theme-BJtnXcPW.js";import{G as j}from"./Grid-Ca03CLp9.js";import{F as I,I as S}from"./OutlinedInput-BXBLTviT.js";import{S as T}from"./Select-uBt0DaXV.js";import{M as C}from"./MenuItem-Dxx1qaOY.js";import{C as _,F as K}from"./FormControlLabel-DNaxlze8.js";import{L as R}from"./ListItemText-BN8Ae5SM.js";import{a as U,T as H}from"./TimePicker-DnmaGtHR.js";import{b as J}from"./DateTimePicker-BETkMyzq.js";import{T as M}from"./TextField-DU014Dqo.js";import{B as Q}from"./Box-CzrcP6gm.js";import{B as V}from"./Button-Dyh-ErXE.js";import{_ as k,a as q,b as o,c as X,d as Y}from"./_has-aTAOOdsQ.js";function ee(t){return function a(r,i,u){switch(arguments.length){case 0:return a;case 1:return o(r)?a:k(function(n,m){return t(r,n,m)});case 2:return o(r)&&o(i)?a:o(r)?k(function(n,m){return t(n,i,m)}):o(i)?k(function(n,m){return t(r,n,m)}):q(function(n){return t(r,i,n)});default:return o(r)&&o(i)&&o(u)?a:o(r)&&o(i)?k(function(n,m){return t(n,m,u)}):o(r)&&o(u)?k(function(n,m){return t(n,i,m)}):o(i)&&o(u)?k(function(n,m){return t(r,n,m)}):o(r)?q(function(n){return t(n,i,u)}):o(i)?q(function(n){return t(r,n,u)}):o(u)?q(function(n){return t(r,i,n)}):t(r,i,u)}}}const P=Number.isInteger||function(a){return a<<0===a};function re(t,a,r){if(P(t)&&X(r)){var i=[].concat(r);return i[t]=a,i}var u={};for(var n in r)u[n]=r[n];return u[t]=a,u}var te=q(function(a){return a==null}),ne=ee(function t(a,r,i){if(a.length===0)return r;var u=a[0];if(a.length>1){var n=!te(i)&&Y(u,i)&&typeof i[u]=="object"?i[u]:P(a[1])?[]:{};r=t(Array.prototype.slice.call(a,1),r,n)}return re(u,r,i)});const ae={string:"",number:0,boolean:!1,enum:"",multienum:[],date:new Date(1970,0,1,0,0),time:new Date(1970,0,1,0,0),datetime:new Date(1970,0,1,0,0),group:{},"group[]":[],"string[]":[],"number[]":[]},A=(t,a)=>(a==null?void 0:a[t.id])||"default"in t&&t.default||ae[t.type],ie=(t,a=void 0)=>{const r={};return t.fields.forEach(i=>{if(i.type==="group"){const u={};i.value.forEach(n=>{u[n.id]=A(n,a&&a[i.id])}),r[i.id]=u}else r[i.id]=A(i,a)}),r},B=({field:t,path:a=[],value:r,dense:i,update:u,onChangeValue:n})=>{const m=e=>{e.preventDefault(),n([...a,e.target.name],e.target.checked)},w=e=>{e.preventDefault(),n([...a,e.target.name],e.target.value)},F=e=>{e.preventDefault();const{value:v}=e.target,b=typeof v=="string"?v.split(","):v;n([...a,e.target.name],b)},h=(e,v)=>{e.preventDefault();let b=e.target.value;v==="number"&&typeof b=="string"?b=Number.parseInt(e.target.value,10):v.includes("[]")&&(b=e.target.value.split(",")),n([...a,e.target.name],b)},p=(e,v)=>{n([...a,v],e)};O({lightWeight:200,darkWeight:800});const{id:s,type:d,name:c,description:N,updatable:G=!0,required:x=!0,xs:E,sm:W,md:$,lg:L,xl:Z}=t,y=!G&&u;let g;const f=i?"small":"medium";if(d==="group")g=l.jsx(z,{title:c,subtitle:N,dense:i,children:l.jsx(j,{container:!0,spacing:2,sx:{p:2},children:t.value.map(e=>l.jsx(B,{field:e,dense:i,path:[...a,s],value:r[e.id],update:u,onChangeValue:n},e.id))})});else if(d==="boolean")g=l.jsx(Q,{sx:{height:1,display:"flex",alignItems:"center"},children:l.jsx(K,{control:l.jsx(_,{name:s,size:f,onChange:m,checked:r,disabled:y}),label:c})});else if(d==="enum")g=l.jsxs(I,{fullWidth:!0,children:[l.jsx(S,{id:`${s}-select-label`,children:c}),l.jsx(T,{labelId:`${s}-select-label`,id:`${s}-select`,value:r,label:c,name:s,size:f,onChange:w,required:x,disabled:y,children:t.value.map(e=>l.jsx(C,{value:e,children:e},e))})]});else if(d==="multienum")g=l.jsxs(I,{fullWidth:!0,children:[l.jsx(S,{id:`${s}-select-label`,children:c}),l.jsx(T,{labelId:`${s}-select-label`,id:`${s}-select`,value:r||[],renderValue:e=>e.join(", "),label:c,name:s,size:f,onChange:F,required:x,disabled:y,multiple:!0,children:t.value.map(e=>l.jsxs(C,{value:e,children:[l.jsx(_,{checked:(r||[]).includes(e)}),l.jsx(R,{primary:e})]},e))})]});else if(d==="date")g=l.jsx(U,{label:c,format:t.format,value:r,slotProps:{field:{size:f}},disabled:y,onChange:e=>p(e,s)});else if(d==="time")g=l.jsx(H,{label:c,format:t.format,value:r,slotProps:{field:{size:f}},disabled:y,onChange:e=>p(e,s)});else if(d==="datetime")g=l.jsx(J,{label:c,format:t.format,value:r,slotProps:{field:{size:f}},disabled:y,onChange:e=>p(e,s)});else{if(d==="group[]")return null;d.includes("[]")?g=l.jsx(M,{required:x,type:"text",label:c,name:s,size:f,variant:"outlined",helperText:"Use comas to separate multiple values",fullWidth:!0,disabled:y,value:r.join(","),onChange:e=>h(e,d)}):g=l.jsx(M,{required:x,type:d,label:c,size:f,name:s,variant:"outlined",fullWidth:!0,value:r,disabled:y,onChange:e=>h(e,d)})}return l.jsx(j,{item:!0,xs:E,sm:W,md:$,lg:L,xl:Z,children:g},s)};B.__docgenInfo={description:"",methods:[],displayName:"ModelFormField",props:{path:{defaultValue:{value:"[]",computed:!1},required:!1}}};const ue=({model:t,saveButtonText:a,dense:r,onSubmit:i,initialValues:u})=>{const n=D.useMemo(()=>ie(t,u),[t,u]),[m,w]=D.useState(n),F=(p,s)=>{w(d=>ne(p,s,d))},h=p=>{p.preventDefault(),i(m)};return l.jsxs(j,{container:!0,component:"form",spacing:2,onSubmit:h,children:[t.fields.map(p=>l.jsx(B,{dense:r,field:p,value:m[p.id],update:!!u,onChangeValue:F},p.id)),l.jsx(j,{item:!0,xs:12,children:l.jsx(V,{type:"submit",variant:"contained",size:r?"small":"medium",children:a})})]})};ue.__docgenInfo={description:`ModelForm component is a generic form component for handling model-based forms.
