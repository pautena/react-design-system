import{r as v}from"./index-CFahbR6w.js";import{a as C,g as b,c as k,b as w}from"./identifier-ChVxdG4r.js";import{u as x,s as R,a as S,m as $}from"./memoTheme-kZCwlU27.js";import{j as U}from"./jsx-runtime-D_zvdyIk.js";import{c as u,k as c}from"./emotion-react.browser.esm-C1MoURgL.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return S({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
