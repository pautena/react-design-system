import{j as i}from"./jsx-runtime-D_zvdyIk.js";import{u as t}from"./drawer.provider-D7JeJs45.js";import{D as o}from"./drawer-menu-item-DV12cUL-.js";import{u as s}from"./useTheme-CPdeOTZ4.js";import{L as m}from"./List-XfzJe0G9.js";const l=({navigation:r})=>{const{size:a}=t(),{spacing:e}=s();return i.jsx(m,{sx:{paddingTop:a==="small"?e(.5):void 0,paddingX:e(a==="small"?.5:1)},children:r.map(n=>i.jsx(o,{item:n},n.id))})};l.__docgenInfo={description:"Content to be shown inside a navigation",methods:[],displayName:"DrawerContent",props:{navigation:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| DrawerNavigationLink
