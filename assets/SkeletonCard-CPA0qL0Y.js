import{r as w,f as C,j as r,i as k,o as m,p as f}from"./iframe-BSF_zI2e.js";import{B as x}from"./Box-CHcsadOg.js";import{g as S,a as R,b as $,s as j,m as U}from"./memoTheme-gZcicJog.js";function M(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function T(e){return parseFloat(e)}function A(e){return S("MuiSkeleton",e)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const B=e=>{const{classes:t,variant:a,animation:n,hasChildren:s,width:o,height:i}=e;return $({root:["root",a,n,s&&"withChildren",s&&!o&&"fitContent",s&&!i&&"heightAuto"]},A,t)},p=m`
  0% {
    opacity: 1;
  }
