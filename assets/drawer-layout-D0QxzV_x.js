import{j as e}from"./iframe-B6ohfiup.js";import{D as p}from"./drawer-CzoJ6iIB.js";import{D as w}from"./drawer-app-bar-vy7qsmOp.js";import{D as d}from"./drawer-content-DDQsrKou.js";import{D as u}from"./drawer.provider-DAueDsRI.js";import{D}from"./drawer-main-CknoDpVJ.js";const c=({children:t,navigation:n,title:i,slots:r,slotsProps:a,...o})=>{const s=r?.drawerAppBar??w,l=r?.drawer??p,m=r?.drawerContent??d;return e.jsxs(u,{...o,children:[e.jsx(s,{title:i,color:"inherit",...a?.drawerAppBar}),e.jsx(l,{...a?.drawer,children:e.jsx(m,{navigation:n,...a?.drawerContent})}),e.jsx(D,{children:t})]})};c.__docgenInfo={description:`DrawerLayout component provides a layout structure with a drawer and an app bar.
