import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{w as G}from"./storybook-mUOLdmZO.js";import{r as J}from"./index-MPVjHJeJ.js";import{C as K}from"./center-container-facIBgF7.js";import{s as Q}from"./memoTheme-DlVnEjn-.js";import{F as X,I as Y}from"./FormControl-B4yIv7Eg.js";import{S as Z}from"./Select-Rw9uOpoh.js";import{C as ee}from"./CircularProgress-DQ5TipBg.js";import{B as R}from"./Box-qtFv-FAL.js";import{L as re}from"./LinearProgress-B6fV38-6.js";import{f as x}from"./chunk-LSEVNFON-G8OzWBoO.js";import{M as $}from"./MenuItem-BpEWtP7Z.js";import{u as te}from"./useTheme-DGVEPoVB.js";const se={small:15,medium:20},y=({label:o,value:n,loading:r=!1,fetching:a=!1,size:h="medium",fullWidth:f=!1,color:t,children:l,onChange:N})=>{const b=J.useId(),H=S=>a?e.jsx(K,{centerVertical:!0,centerHorizontal:!0,children:e.jsx(ee,{color:"inherit",size:se[h]})}):r?e.jsxs(R,{display:"flex",flexDirection:"column",children:[S,e.jsx(re,{color:"inherit",sx:{position:"absolute",left:0,right:0,bottom:0}})]}):S,U=Q(X)(()=>t?{label:{color:t},".MuiOutlinedInput-notchedOutline":{borderColor:`${t} !important`},".MuiInputBase-root":{color:t},".MuiSelect-icon":{fill:t}}:{});return e.jsxs(U,{fullWidth:f,children:[e.jsx(Y,{id:b,children:o}),e.jsx(Z,{labelId:b,id:b,value:n,label:o,onChange:N,disabled:a,size:h,renderValue:H,children:l})]})};y.__docgenInfo={description:`A custom Select component that extends the functionality of the Material-UI Select component.
