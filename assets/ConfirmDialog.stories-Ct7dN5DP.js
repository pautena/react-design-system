import{r as y,j as s}from"./iframe-BSF_zI2e.js";import{S}from"./storybook-CzW-fV4e.js";import{B as O}from"./BootstrapDialog-Bn-CEw0-.js";import{T as j}from"./TextField-VzSPQ_LP.js";import{D as h}from"./DialogContentText-DtH5NRD-.js";function p({open:l,title:m,loading:c,disabled:u,confirmText:e="Confirm",cancelText:o="Cancel",passphrase:d,children:C,onConfirm:D,onCancel:f}){const[g,x]=y.useState(""),b=!d||g===d;return s.jsxs(O,{title:m,loading:c,disabled:c||u,disableAccept:!b,open:l,onClose:f,acceptable:!0,cancelable:!0,callCloseWhenCancel:!1,acceptText:e,cancelText:o,onCancel:f,onAccept:D,children:[C,d&&s.jsx(j,{size:"small",fullWidth:!0,value:g,onChange:T=>x(T.target.value),placeholder:d})]})}p.__docgenInfo={description:`ConfirmDialog component renders a dialog to ask a user to confirm an action
