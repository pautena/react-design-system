import{r as b,B as ce,j as t,e as Z,N as E,O as L,P as ge,K as ye,Q as ve,t as fe,S as H,b as ee,l as ne}from"./iframe-u8LB376j.js";import{b as be}from"./storybook-gYjJ4lHD.js";import{c as he,d as qe,a as Se,T as R,b as ke,e as we}from"./TableSortLabel-CGouHft9.js";import{T as O}from"./TableCell-DQy07XZT.js";import{B as z}from"./Box-r6KuYIW2.js";import{C as xe}from"./CircularProgress-DnZ0hM6Q.js";import{T as N,c as D}from"./Typography-yXzabRJh.js";import{T as Te,a as Ce,t as P,b as je,c as Fe}from"./ToggleButton-BAQdfL1e.js";import{C as Be}from"./Close-BiXZ-HyV.js";import{T as I}from"./TextField-DhrNMBpy.js";import{I as Y}from"./InputAdornment-BDVoCqre.js";import{P as Ie}from"./Popover-D3TQq2Kw.js";import{a as te,s as ae,m as Ae}from"./memoTheme-V5gp6nHU.js";import{s as ze}from"./styled-j-Jxc9wR.js";import{u as De}from"./useThemeProps-CoUj8Mfc.js";import{a as re,g as Qe}from"./generateUtilityClasses-CoM_PQv9.js";import{B as Re}from"./Button-B1FhpMe7.js";import{I as ie}from"./IconButton-DfMYPZbC.js";import{M as B}from"./MenuItem-B5GQQUbP.js";import{P as Oe}from"./Paper-ufo0IKvl.js";import{C as Pe}from"./Chip-Qr6XErzi.js";import"./preload-helper-PPVm8Dsz.js";import"./notification-center.provider-CR_O05N3.js";import"./useSlot-C0yEUZxy.js";import"./createSimplePaletteValueFilter-BA1C3KMz.js";import"./useTheme-DuCPUz7t.js";import"./ClickAwayListener-WJK6T669.js";import"./Grow-C0Me-irx.js";import"./index-aSWeh4o7.js";import"./index-CQl9WEtC.js";import"./ownerDocument-DW-IO8s5.js";import"./Close-DCdKt3RS.js";import"./format-Df_VsWsY.js";import"./extends-CF3RwP-h.js";import"./KeyboardArrowRight-CFGvNkiK.js";import"./OutlinedInput-CItTCf1Q.js";import"./useFormControl-D0pQ51AE.js";import"./isMuiElement-DZKLzQP7.js";import"./ownerWindow-HkKU3E4x.js";import"./debounce-Be36O1Ab.js";import"./Toolbar-DYQHMqkS.js";import"./Select-C7QAlleG.js";import"./useSlotProps-BTk2FtMy.js";import"./Modal-PS6z-5gu.js";import"./Portal-Dozv2roy.js";import"./getActiveElement-BQgAPKnO.js";import"./Fade-Bjv-lycE.js";import"./List-DDzKp9r0.js";import"./useControlled-Cm5Rncbd.js";import"./ArrowDropDown-BdLbldV-.js";import"./FormHelperText-BLVupkcU.js";import"./listItemIconClasses-B8O87iOu.js";import"./listItemTextClasses-Bvxa1hv0.js";import"./dividerClasses-DWExi19l.js";const $e=fe(),Me=ze("div",{name:"MuiStack",slot:"Root"});function We(e){return De({props:e,name:"MuiStack",defaultTheme:$e})}function Ne(e,n){const a=b.Children.toArray(e).filter(Boolean);return a.reduce((i,p,r)=>(i.push(p),r<a.length-1&&i.push(b.cloneElement(n,{key:`separator-${r}`})),i),[])}const Ve=e=>({row:"Left","row-reverse":"Right",column:"Top","column-reverse":"Bottom"})[e],Le=({ownerState:e,theme:n})=>{let a={display:"flex",flexDirection:"column",...E({theme:n},L({values:e.direction,breakpoints:n.breakpoints.values}),i=>({flexDirection:i}))};if(e.spacing){const i=ge(n),p=Object.keys(n.breakpoints.values).reduce((m,d)=>((typeof e.spacing=="object"&&e.spacing[d]!=null||typeof e.direction=="object"&&e.direction[d]!=null)&&(m[d]=!0),m),{}),r=L({values:e.direction,base:p}),s=L({values:e.spacing,base:p});typeof r=="object"&&Object.keys(r).forEach((m,d,c)=>{if(!r[m]){const q=d>0?r[c[d-1]]:"column";r[m]=q}}),a=ye(a,E({theme:n},s,(m,d)=>e.useFlexGap?{gap:H(i,m)}:{"& > :not(style):not(style)":{margin:0},"& > :not(style) ~ :not(style)":{[`margin${Ve(d?r[d]:e.direction)}`]:H(i,m)}}))}return a=ve(n.breakpoints,a),a};function Ge(e={}){const{createStyledComponent:n=Me,useThemeProps:a=We,componentName:i="MuiStack"}=e,p=()=>te({root:["root"]},m=>re(i,m),{}),r=n(Le);return b.forwardRef(function(m,d){const c=a(m),k=ce(c),{component:q="div",direction:l="column",spacing:y=0,divider:u,children:v,className:T,useFlexGap:C=!1,...f}=k,x={direction:l,spacing:y,useFlexGap:C},h=p();return t.jsx(r,{as:q,ownerState:x,ref:d,className:Z(h.root,T),...f,children:u?Ne(v,u):v})})}function _e(e){return b.Children.toArray(e).filter(n=>b.isValidElement(n))}const _=Ge({createStyledComponent:ae("div",{name:"MuiStack",slot:"Root"}),useThemeProps:e=>ee({props:e,name:"MuiStack"})});function Ue(e){return re("MuiToggleButtonGroup",e)}const g=Qe("MuiToggleButtonGroup",["root","selected","horizontal","vertical","disabled","grouped","groupedHorizontal","groupedVertical","fullWidth","firstButton","lastButton","middleButton"]),Ke=e=>{const{classes:n,orientation:a,fullWidth:i,disabled:p}=e,r={root:["root",a,i&&"fullWidth"],grouped:["grouped",`grouped${ne(a)}`,p&&"disabled"],firstButton:["firstButton"],lastButton:["lastButton"],middleButton:["middleButton"]};return te(r,Ue,n)},Ee=ae("div",{name:"MuiToggleButtonGroup",slot:"Root",overridesResolver:(e,n)=>{const{ownerState:a}=e;return[{[`& .${g.grouped}`]:n.grouped},{[`& .${g.grouped}`]:n[`grouped${ne(a.orientation)}`]},{[`& .${g.firstButton}`]:n.firstButton},{[`& .${g.lastButton}`]:n.lastButton},{[`& .${g.middleButton}`]:n.middleButton},n.root,a.orientation==="vertical"&&n.vertical,a.fullWidth&&n.fullWidth]}})(Ae(({theme:e})=>({display:"inline-flex",borderRadius:(e.vars||e).shape.borderRadius,variants:[{props:{orientation:"vertical"},style:{flexDirection:"column",[`& .${g.grouped}`]:{[`&.${g.selected} + .${g.grouped}.${g.selected}`]:{borderTop:0,marginTop:0}},[`& .${g.firstButton},& .${g.middleButton}`]:{borderBottomLeftRadius:0,borderBottomRightRadius:0},[`& .${g.lastButton},& .${g.middleButton}`]:{marginTop:-1,borderTop:"1px solid transparent",borderTopLeftRadius:0,borderTopRightRadius:0},[`& .${g.lastButton}.${P.disabled},& .${g.middleButton}.${P.disabled}`]:{borderTop:"1px solid transparent"}}},{props:{fullWidth:!0},style:{width:"100%"}},{props:{orientation:"horizontal"},style:{[`& .${g.grouped}`]:{[`&.${g.selected} + .${g.grouped}.${g.selected}`]:{borderLeft:0,marginLeft:0}},[`& .${g.firstButton},& .${g.middleButton}`]:{borderTopRightRadius:0,borderBottomRightRadius:0},[`& .${g.lastButton},& .${g.middleButton}`]:{marginLeft:-1,borderLeft:"1px solid transparent",borderTopLeftRadius:0,borderBottomLeftRadius:0},[`& .${g.lastButton}.${P.disabled},& .${g.middleButton}.${P.disabled}`]:{borderLeft:"1px solid transparent"}}}]}))),He=b.forwardRef(function(n,a){const i=ee({props:n,name:"MuiToggleButtonGroup"}),{children:p,className:r,color:s="standard",disabled:o=!1,exclusive:m=!1,fullWidth:d=!1,onChange:c,orientation:k="horizontal",size:q="medium",value:l,...y}=i,u={...i,disabled:o,fullWidth:d,orientation:k,size:q},v=Ke(u),T=b.useCallback((S,w)=>{if(!c)return;const F=l&&l.indexOf(w);let Q;l&&F>=0?(Q=l.slice(),Q.splice(F,1)):Q=l?l.concat(w):[w],c(S,Q)},[c,l]),C=b.useCallback((S,w)=>{c&&c(S,l===w?null:w)},[c,l]),f=b.useMemo(()=>({className:v.grouped,onChange:m?C:T,value:l,size:q,fullWidth:d,color:s,disabled:o}),[v.grouped,m,C,T,l,q,d,s,o]),x=_e(p),h=x.length,j=S=>{const w=S===0,F=S===h-1;return w&&F?"":w?v.firstButton:F?v.lastButton:v.middleButton};return t.jsx(Ee,{role:"group",className:Z(v.root,r),ref:a,ownerState:u,...y,children:t.jsx(Te.Provider,{value:f,children:x.map((S,w)=>t.jsx(Ce.Provider,{value:j(w),children:S},w))})})}),le=({data:e,columns:n,loading:a,emptyMessage:i,sorting:p=[],onSortingChange:r,onRowClick:s,getRowId:o})=>{const m=Math.max(n.length,1),d=!a&&e.length===0,c=!!s,k=l=>{if(!r)return;const y=p.find(u=>u.id===l);y?y.desc?r([]):r([{id:l,desc:!0}]):r([{id:l,desc:!1}])},q=l=>{const y=p.find(u=>u.id===l);return y?y.desc?"desc":"asc":!1};return t.jsx(he,{children:t.jsxs(qe,{size:"small","aria-busy":a,children:[t.jsx(Se,{sx:{backgroundColor:"grey.50"},children:t.jsx(R,{children:n.map(l=>{const y=q(l.id),u=l.enableSorting&&r;return t.jsx(O,{align:l.meta?.align,sortDirection:y,sx:{fontWeight:600,color:"text.secondary",width:l.meta?.width,minWidth:l.meta?.minWidth,maxWidth:l.meta?.maxWidth},children:u?t.jsx(ke,{active:y!==!1,direction:y===!1?"asc":y,onClick:()=>k(l.id),children:l.header}):l.header},l.id)})})}),t.jsx(we,{children:a?t.jsx(R,{children:t.jsx(O,{colSpan:m,children:t.jsxs(z,{display:"flex",alignItems:"center",gap:1,py:2,children:[t.jsx(xe,{size:20}),t.jsx(N,{variant:"body2",children:"Loading"})]})})}):d?t.jsx(R,{children:t.jsx(O,{colSpan:m,children:t.jsx(N,{variant:"body2",color:"text.secondary",py:2,children:i})})}):e.map((l,y)=>{const u=o?o(l,y):String(y);return t.jsx(R,{hover:c,onClick:s?()=>s(l):void 0,sx:c?{cursor:"pointer"}:void 0,children:n.map(v=>{const T=v.accessorKey?l[v.accessorKey]:void 0,C=v.cell?v.cell(l):String(T??"");return t.jsx(O,{align:v.meta?.align,sx:{width:v.meta?.width,minWidth:v.meta?.minWidth,maxWidth:v.meta?.maxWidth},children:C},v.id)})},u)})})]})})};le.__docgenInfo={description:"",methods:[],displayName:"RemoteDataTableBody",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"TData"}],raw:"TData[]"},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  header: ReactNode;
...
This hook aggregates pagination, sorting, and filters state.`,...A.parameters?.docs?.description}}};const ct=["Default","SortedByCreatedDate","WithQueryBuilder","UsingHook"];export{$ as Default,M as SortedByCreatedDate,A as UsingHook,W as WithQueryBuilder,ct as __namedExportsOrder,pt as default};
