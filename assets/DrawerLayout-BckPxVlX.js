import{j as e}from"./iframe-CnbMuzLM.js";import{D as p}from"./Drawer-BE8fd7W6.js";import{D as d}from"./DrawerAppBar-B0COHNpv.js";import{D as u}from"./DrawerContent-M0tT0EwN.js";import{D as w}from"./Drawer.provider-DXa27qVc.js";import{D as c}from"./DrawerMain-DxfvZb1e.js";function v({children:t,navigation:n,title:i,slots:a,slotsProps:r,...o}){const s=a?.drawerAppBar??d,l=a?.drawer??p,m=a?.drawerContent??u;return e.jsxs(w,{...o,children:[e.jsx(s,{title:i,color:"inherit",...r?.drawerAppBar}),e.jsx(l,{...r?.drawer,children:e.jsx(m,{navigation:n,...r?.drawerContent})}),e.jsx(c,{children:t})]})}v.__docgenInfo={description:`DrawerLayout component provides a layout structure with a drawer and an app bar.
