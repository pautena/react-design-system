import{f as d,w,b as v}from"./storybook-BmI9ftC1.js";import{j as e,r as u}from"./iframe-VMkoG4ZL.js";import{d as b,I as x,P as k}from"./NotificationCenter.provider-Csm6e6JQ.js";import{D as T}from"./DateRangeCalendar-Dy2QG6ZM.js";import{T as j}from"./TextField-CErgvfdJ.js";import{I as P}from"./InputAdornment-DWJH5O52.js";import{C as S}from"./Collapse-CgtMcFv0.js";const V=b(e.jsx("path",{d:"M17 12h-5v5h5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1zm3 18H5V8h14z"}));function m({defaultValue:s,format:r,label:c,fullWidth:p,onValueChange:f,size:h="medium"}){const[g,o]=u.useState(!1),[l,y]=u.useState(s),D=(n,i)=>{y(n),f(n,i),o(i<1)};return e.jsxs(e.Fragment,{children:[e.jsx(j,{label:c,fullWidth:p,size:h,value:`${d(l[0],r)} - ${l[1]?d(l[1],r):r.toUpperCase()}`,InputProps:{endAdornment:e.jsx(P,{position:"end",children:e.jsx(x,{onClick:()=>o(n=>!n),"aria-label":"open calendar",children:e.jsx(V,{})})})}}),e.jsx(k,{children:e.jsx(S,{in:g,"aria-label":"calendar collapse",children:e.jsx(T,{defaultValue:s,onValueChange:D})})})]})}m.__docgenInfo={description:"DateRangePicker component allows users to select a date range.",methods:[],displayName:"DateRangePicker",props:{label:{required:!0,tsType:{name:"string"},description:"The label for the date range picker."},defaultValue:{required:!0,tsType:{name:"tuple",raw:"[Date, Date | undefined]",elements:[{name:"Date"},{name:"union",raw:"Date | undefined",elements:[{name:"Date"},{name:"undefined"}]}]},description:"The default value for the date range picker."},format:{required:!0,tsType:{name:"string"},description:"The format in which the date range should be displayed."},fullWidth:{required:!1,tsType:{name:"boolean"},description:`If true, the date range picker will take up the full width of its container.
...
}`,...t.parameters?.docs?.source}}};const M=["Default","Small"],E=Object.freeze(Object.defineProperty({__proto__:null,Default:a,Small:t,__namedExportsOrder:M,default:I},Symbol.toStringTag,{value:"Module"}));export{m as D,a,E as b};
