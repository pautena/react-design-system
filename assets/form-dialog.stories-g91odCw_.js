import{j as t}from"./iframe-CyC2w49y.js";import{S as w}from"./storybook-CDs3mFlN.js";import{B as z}from"./bootstrap-dialog-DoDJgQZh.js";import{G as c}from"./Grid-DcpqZmzV.js";import{T as g}from"./TextField-DjsTrXPP.js";const B=a=>{const i=new FormData(a.currentTarget),r={};return i.forEach((u,l)=>{r[l]=u}),r},d=({open:a,title:i,loading:r,disabled:u,submitText:l="Submit",cancelText:F="Cancel",children:k,onSubmit:q,onCancel:m})=>{const G=p=>{p.preventDefault(),q(B(p))};return t.jsx(z,{component:"form",componentProps:{onSubmit:G},title:i,loading:r,disabled:r||u,open:a,onClose:m,callCloseWhenCancel:!1,cancelable:!0,acceptable:!0,cancelText:F,onCancel:m,acceptText:l,acceptType:"submit",children:k})};d.__docgenInfo={description:`A generic form dialog component that wraps a BootstrapDialog and handles form submission.
...
@param data - The data to be submitted.`}},composes:["Omit"]};const W={title:"Components/Dialogs/FormDialog",component:d,parameters:{layout:"centered"},render:a=>t.jsx(w,{component:d,args:a})},e={args:{open:!0,title:"Lorem ipsum",children:t.jsxs(c,{container:!0,spacing:2,children:[t.jsx(c,{size:{xs:12},children:t.jsx(g,{name:"message",label:"Message",fullWidth:!0,required:!0,variant:"outlined"})}),t.jsx(c,{size:{xs:12},children:t.jsx(g,{name:"amount",label:"Amount",fullWidth:!0,required:!0,variant:"outlined"})})]})}},n={args:{...e.args,loading:!0}},o={args:{...e.args,disabled:!0}},s={args:{...e.args,submitText:"Create token",cancelText:"Don't create a token"}};var f,b,x;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    open: true,
    title: "Lorem ipsum",
...
}`,...(_=(j=s.parameters)==null?void 0:j.docs)==null?void 0:_.source}}};const L=["Default","Loading","Disabled","CustomButtonText"],V=Object.freeze(Object.defineProperty({__proto__:null,CustomButtonText:s,Default:e,Disabled:o,Loading:n,__namedExportsOrder:L,default:W},Symbol.toStringTag,{value:"Module"}));export{e as D,d as F,V as f};
