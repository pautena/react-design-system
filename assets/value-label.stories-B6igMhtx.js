import{j as g}from"./jsx-runtime-D_zvdyIk.js";import"./value-edit-COYVhyYg.js";import{D as re}from"./value-displays.types-y9Dsh-vS.js";import{g as se,V as oe}from"./value-content-C6ypxIMR.js";import{L as y}from"./label-JbAX7QCH.js";import{G as le}from"./Grid-7GKz2fft.js";import{w as te}from"./storybook-BbnjQYC6.js";const Y=({label:L,value:r,placeholder:v=re,color:e,variant:a})=>{const Z=se(L),ee=Array.isArray(r)?r.map((ae,b)=>g.jsx(y,{text:ae.toString()||v,variant:Array.isArray(a)?a[b]:a,color:Array.isArray(e)?e[b]:e},b)):g.jsx(y,{text:(r==null?void 0:r.toString())||v,variant:Array.isArray(a)?a[0]:a,color:Array.isArray(e)?e[0]:e});return g.jsx(oe,{label:L,children:g.jsx(le,{container:!0,gap:1,"aria-labelledby":Z,children:ee})})};Y.__docgenInfo={description:"Displays a label component value with a label",methods:[],displayName:"ValueLabel",props:{label:{required:!0,tsType:{name:"string"},description:"Name of the displayed value"},value:{required:!1,tsType:{name:"T"},description:"Value displayed"},placeholder:{required:!1,tsType:{name:"string"},description:"String rendered if value is undefined",defaultValue:{value:'"-"',computed:!1}},dense:{required:!1,tsType:{name:"boolean"},description:`The value has to be displayed as compact or not.
