import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-CFahbR6w.js";import{E as H}from"./ExpandMore-DAoso8Lj.js";import{c as J,T as l}from"./Typography-ByJtF3w8.js";import{C as K}from"./Close-scFSIpVJ.js";import{B as Q}from"./board-Dv_wNvOr.js";import{A as U,a as X}from"./Alert-BP5pwJe5.js";import{B as h}from"./Box-CohR-H6x.js";import{A as Y,S as Z}from"./notification-center.provider-BTkGblW5.js";import{C as ee}from"./Collapse-CfEEf4yd.js";import{I as y}from"./IconButton-ez-CP-G1.js";import{w as re}from"./storybook-neFVUtWe.js";import{B as ae}from"./Button-CRc0Eyhl.js";const se=J(e.jsx("path",{d:"m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"}),"ExpandLess"),te={[`& .${X.message}`]:{width:1}},c=u.forwardRef(({severity:p,iconMapping:m,title:g,message:z,metadata:d,metadataComponent:P,onClose:f,sx:$={}},F)=>{const[x,V]=u.useState(!1);return e.jsx(U,{ref:F,severity:p,iconMapping:m,onClose:f,action:e.jsxs(h,{display:"flex",flexDirection:"column",children:[e.jsx(y,{color:"inherit",onClick:f,children:e.jsx(K,{fontSize:"small"})}),d&&e.jsx(y,{color:"inherit",onClick:()=>V(G=>!G),children:x?e.jsx(se,{fontSize:"small"}):e.jsx(H,{fontSize:"small"})})]}),sx:{...te,...$},children:e.jsxs(h,{sx:{w:1},children:[g&&e.jsx(Y,{children:g}),z,d&&e.jsx(ee,{in:x,sx:{mt:2},children:e.jsx(Q,{content:d,children:P})})]})})});c.__docgenInfo={description:"",methods:[],displayName:"ExpandableAlert",props:{severity:{required:!0,tsType:{name:"AlertColor"},description:""},iconMapping:{required:!1,tsType:{name:"Partial",elements:[{name:"Record",elements:[{name:"AlertColor"},{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"Record<AlertColor, React.ReactNode>"}],raw:"Partial<Record<AlertColor, React.ReactNode>>"},description:""},title:{required:!1,tsType:{name:"string"},description:""},message:{required:!0,tsType:{name:"string"},description:""},metadata:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},metadataComponent:{required:!1,tsType:{name:"ReactElement"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"SxProps",elements:[{name:"Theme"}],raw:"SxProps<Theme>"},description:"",defaultValue:{value:"{}",computed:!1}}}};const oe={title:"Components/Alerts/ExpandableAlert",component:c,decorators:[re({width:500})],parameters:{layout:"centered"}},r={args:{severity:"info",title:"Lorem ipsum",message:"Lorem ipsum dolor sit amet",metadata:["lorem: ipsum","foo: bar","header: this","host: localhost"]}},t={args:{...r.args,severity:"success"}},o={args:{...r.args,severity:"error"}},n={args:{...r.args,severity:"warning"}},i={args:{severity:"info",title:"Lorem ipsum",message:"Lorem ipsum dolor sit amet"}},a=()=>e.jsx(c,{severity:"info",onClose:()=>null,title:"Lorem ipsum",message:"Lorem ipsum dolor sit amet",metadata:["lorem: ipsum","foo: bar","header: this","host: localhost"],metadataComponent:e.jsxs(e.Fragment,{children:[e.jsx(l,{variant:"h6",children:"lorem: ipsum"}),e.jsx(l,{variant:"caption",children:"foo: bar"}),e.jsx(l,{variant:"body2",sx:{textDecoration:"line-through"},children:"header: this"}),e.jsx(l,{variant:"body2",fontWeight:700,children:"host: localhost"})]})}),s=()=>{const[p,m]=u.useState(!1);return e.jsxs(h,{children:[e.jsx(ae,{variant:"contained",onClick:()=>m(!0),children:"Snackbar"}),e.jsx(Z,{open:p,children:e.jsx(c,{severity:"info",onClose:()=>m(!1),title:"Lorem ipsum",message:"Lorem ipsum dolor sit amet",metadata:["lorem: ipsum","foo: bar","header: this","host: localhost"]})})]})};a.__docgenInfo={description:"",methods:[],displayName:"MetadataCustomComponent"};s.__docgenInfo={description:"",methods:[],displayName:"SnackbarAlert"};var b,v,S;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    severity: "info",
    title: "Lorem ipsum",
...
}`,...(W=(O=s.parameters)==null?void 0:O.docs)==null?void 0:W.source}}};const ne=["Default","Success","Error","Warning","WihtoutMetadata","MetadataCustomComponent","SnackbarAlert"],ve=Object.freeze(Object.defineProperty({__proto__:null,Default:r,Error:o,MetadataCustomComponent:a,SnackbarAlert:s,Success:t,Warning:n,WihtoutMetadata:i,__namedExportsOrder:ne,default:oe},Symbol.toStringTag,{value:"Module"}));export{r as D,c as E,ve as e};
