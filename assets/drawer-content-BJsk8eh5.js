import{j as i}from"./iframe-DF1-CE8W.js";import{u as t}from"./drawer.provider-ClJnxMp3.js";import{D as o}from"./drawer-menu-item-BrhEstO3.js";import{u as s}from"./useTheme-CzxbhnGL.js";import{L as m}from"./List-_NvLlhuE.js";const l=({navigation:r})=>{const{size:a}=t(),{spacing:e}=s();return i.jsx(m,{sx:{paddingTop:a==="small"?e(.5):void 0,paddingX:e(a==="small"?.5:1)},children:r.map(n=>i.jsx(o,{item:n},n.id))})};l.__docgenInfo={description:"Content to be shown inside a navigation",methods:[],displayName:"DrawerContent",props:{navigation:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| DrawerNavigationLink
