import{r as B,j as e}from"./iframe-B6ohfiup.js";import{f as x}from"./chunk-X5FFPT5Z-J2rk6w_l.js";import{c as M}from"./storybook-CKEMMUzk.js";import{C as W}from"./center-container-DoUXDCSP.js";import{s as k}from"./memoTheme-CC-1Q7gO.js";import{F as z,I as _}from"./OutlinedInput-aHMVGmm-.js";import{S as q}from"./Select-DwXhrFZO.js";import{C as A}from"./CircularProgress-DNnVD90t.js";import{B as C}from"./Box-CXgehUqD.js";import{L as P}from"./LinearProgress-7EiUzHcz.js";import{M as T}from"./MenuItem-godXy_xk.js";import{u as w}from"./useTheme-DsWhHYnr.js";const F={small:15,medium:20},y=({label:o,value:n,loading:r=!1,fetching:a=!1,size:h="medium",fullWidth:f=!1,color:t,children:l,onChange:j})=>{const b=B.useId(),I=S=>a?e.jsx(W,{centerVertical:!0,centerHorizontal:!0,children:e.jsx(A,{color:"inherit",size:F[h]})}):r?e.jsxs(C,{display:"flex",flexDirection:"column",children:[S,e.jsx(P,{color:"inherit",sx:{position:"absolute",left:0,right:0,bottom:0}})]}):S,v=k(z)(()=>t?{label:{color:t},".MuiOutlinedInput-notchedOutline":{borderColor:`${t} !important`},".MuiInputBase-root":{color:t},".MuiSelect-icon":{fill:t}}:{});return e.jsxs(v,{fullWidth:f,children:[e.jsx(_,{id:b,children:o}),e.jsx(q,{labelId:b,id:b,value:n,label:o,onChange:j,disabled:a,size:h,renderValue:I,children:l})]})};y.__docgenInfo={description:`A custom Select component that extends the functionality of the Material-UI Select component.
