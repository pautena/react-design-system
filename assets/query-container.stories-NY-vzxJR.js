import{j as e}from"./iframe-DF1-CE8W.js";import{b as R}from"./storybook-BMS3iT1X.js";import{L as $}from"./loading-area-B7vribQn.js";import{A as p,a as f}from"./notification-center.provider-BuC7hSZT.js";import{B as k}from"./Box-94sBtQLg.js";import{L as G}from"./LinearProgress-XCSDTLtj.js";import{T as H}from"./Typography-DnRJLN7A.js";function h({fetching:r=!1,loading:l=!1,error:m,success:g,children:z}){const N=Array.isArray(r)?r.some(u=>u):r;return(Array.isArray(l)?l.some(u=>u):l)?e.jsx($,{}):m?e.jsxs(p,{severity:"error",role:"alert","aria-describedby":"error",children:[m.name&&e.jsx(f,{role:"heading",children:m.name}),m.message]}):e.jsxs(k,{children:[g&&e.jsxs(p,{severity:"success",role:"alert","aria-describedby":"success",sx:{mb:2},children:[g.name&&e.jsx(f,{role:"heading",children:g.name}),g.message]}),N&&e.jsx(G,{sx:{width:1,mb:1}}),z]})}h.__docgenInfo={description:"Component to show different indicators based on the usual api query statuses",methods:[],displayName:"QueryContainer",props:{fetching:{defaultValue:{value:"false",computed:!1},required:!1},loading:{defaultValue:{value:"false",computed:!1},required:!1}}};const J={title:"Components/Feedback/QueryContainer",component:h,decorators:[R()],parameters:{layout:"fullscreen"},render:r=>e.jsx(k,{height:300,children:e.jsx(h,{...r,children:e.jsx(H,{children:"Children content"})})})},s={args:{loading:!0}},a={args:{fetching:!0}},n={args:{loading:!0,fetching:!0}},t={args:{fetching:!1,error:{name:"Sign in error",message:"User and password doesn't match"}}},o={args:{fetching:!1,error:{message:"Internal error"}}},c={args:{fetching:!1,success:{name:"Item added",message:"The new item has been created with id 1"}}},i={args:{fetching:!1,success:{message:"The new item has been created with id 1"}}},d={args:{fetching:!1}};var y,x,b;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    loading: true
  }
}`,...(b=(x=s.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var S,j,w;a.parameters={...a.parameters,docs:{...(S=a.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    fetching: true
  }
