import{j as u}from"./jsx-runtime-D_zvdyIk.js";import{V as j}from"./value-boolean-BJWY8xws.js";import{V as x}from"./value-datetime-DFSwRBOM.js";import{V as c}from"./value-text-B22TXR-3.js";import{G as b}from"./group-value-card-CStfaqbW.js";import{V as v}from"./value-item-BSaL989U.js";import{G as p}from"./Grid-BUgJ8WKb.js";import{D as w}from"./DataGrid-AThXi9FH.js";const f=(l=12)=>{const i=(e,t,r)=>{const n=e[t];return e[t]+=r,e[t]>l?(e[t]=r,!1):(e[t]==l&&(e[t]=0),n>0)};return{xs:0,sm:0,md:0,lg:0,xl:0,increment:function({xs:e=0,sm:t=0,md:r=0,lg:n=0,xl:a=0}){const s=t||e,o=r||s,m=n||o,d=a||m;return{xs:i(this,"xs",e),sm:i(this,"sm",s),md:i(this,"md",o),lg:i(this,"lg",m),xl:i(this,"xl",d)}}}},q=(l,i,{dense:e}={})=>{const{id:t,name:r,type:n}=l,a=i[t];return n==="boolean"?u.jsx(j,{dense:e,label:r,value:a}):n==="date"||n==="time"||n==="datetime"?u.jsx(x,{dense:e,label:r,value:a,format:l.format}):typeof a=="object"&&!Array.isArray(a)?u.jsx(c,{dense:e,label:r,value:JSON.stringify(a)}):u.jsx(c,{dense:e,label:r,value:a==null?void 0:a.toString()})},F=({field:{name:l,description:i,value:e},instance:t,dense:r})=>{const n=[{field:"id",headerName:"ID",width:70}];e.forEach(s=>{n.push({field:s.id,headerName:s.name})});const a=t.map((s,o)=>({id:o,...s}));return u.jsx(b,{title:l,subtitle:i,dense:r,children:u.jsx(p,{item:!0,xs:12,children:u.jsx(w,{rows:a,columns:n,density:r?"compact":"standard",disableRowSelectionOnClick:!0,pageSizeOptions:[5],initialState:{pagination:{paginationModel:{pageSize:5}}},sx:{height:400}})})})},h=({field:{name:l,description:i,value:e},instance:t,dense:r})=>{const n=f();return u.jsx(b,{title:l,subtitle:i,dense:r,children:e.map(a=>{const{id:s,xs:o,sm:m,md:d,lg:g,xl:y}=a,k=n.increment(a);return u.jsx(v,{xs:o,sm:m,md:d,lg:g,xl:y,bordered:k,children:q(a,t,{dense:r})},s)})})},B=({model:l,instance:i,dense:e})=>{const t=f();return u.jsx(p,{container:!0,spacing:e?1:2,children:l.fields.map(r=>{const{id:n,type:a,xs:s=3,sm:o=0,md:m=0,lg:d=0,xl:g=0}=r;if(a==="group")return t.increment({xs:12}),u.jsx(p,{item:!0,xs:12,children:u.jsx(h,{field:r,instance:i[n],dense:e})},n);if(a==="group[]")return t.increment({xs:12}),u.jsx(p,{item:!0,xs:12,children:u.jsx(F,{field:r,instance:i[n],dense:e})},n);const y=t.increment(r);return u.jsx(v,{xs:s,sm:o,md:m,lg:d,xl:g,bordered:y,children:q(r,i,{dense:e})},n)})})};B.__docgenInfo={description:`ObjectDetails component renders detailed information about a given instance of a model.
