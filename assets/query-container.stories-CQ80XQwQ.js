import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{f as R}from"./storybook-neFVUtWe.js";import{L as $}from"./loading-area-Bz7QugPc.js";import{A as h}from"./Alert-BP5pwJe5.js";import{A as p}from"./notification-center.provider-BTkGblW5.js";import{B as k}from"./Box-CohR-H6x.js";import{L as G}from"./LinearProgress-8-13sGHv.js";import{T as H}from"./Typography-ByJtF3w8.js";function f({fetching:r=!1,loading:l=!1,error:m,success:g,children:z}){const N=Array.isArray(r)?r.some(u=>u):r;return(Array.isArray(l)?l.some(u=>u):l)?e.jsx($,{}):m?e.jsxs(h,{severity:"error",role:"alert","aria-describedby":"error",children:[m.name&&e.jsx(p,{role:"heading",children:m.name}),m.message]}):e.jsxs(k,{children:[g&&e.jsxs(h,{severity:"success",role:"alert","aria-describedby":"success",sx:{mb:2},children:[g.name&&e.jsx(p,{role:"heading",children:g.name}),g.message]}),N&&e.jsx(G,{sx:{width:1,mb:1}}),z]})}f.__docgenInfo={description:"Component to show different indicators based on the usual api query statuses",methods:[],displayName:"QueryContainer",props:{fetching:{defaultValue:{value:"false",computed:!1},required:!1},loading:{defaultValue:{value:"false",computed:!1},required:!1}}};const J={title:"Components/Feedback/QueryContainer",component:f,decorators:[R()],parameters:{layout:"fullscreen"},render:r=>e.jsx(k,{height:300,children:e.jsx(f,{...r,children:e.jsx(H,{children:"Children content"})})})},s={args:{loading:!0}},a={args:{fetching:!0}},n={args:{loading:!0,fetching:!0}},t={args:{fetching:!1,error:{name:"Sign in error",message:"User and password doesn't match"}}},o={args:{fetching:!1,error:{message:"Internal error"}}},c={args:{fetching:!1,success:{name:"Item added",message:"The new item has been created with id 1"}}},i={args:{fetching:!1,success:{message:"The new item has been created with id 1"}}},d={args:{fetching:!1}};var y,x,S;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    loading: true
  }
