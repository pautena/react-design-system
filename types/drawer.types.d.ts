import { ComponentType, CSSProperties, HTMLAttributes, PropsWithChildren, ReactElement } from '../../node_modules/react';
import { BadgeVariant } from '../components/data-display/badge/badge';
import { BulletVariant } from '../components/data-display/bullet/bullet';
/**
 * Drawer states.
 ...
 */
export declare const getDrawerItemColors: (selected: boolean | undefined) => {
    colorClass: string;
 ...
 */
export interface DrawerAppBarProps extends PropsWithChildren<HTMLAttributes<HTMLElement>> {
    /**
