import { OnChangeFn, PaginationState, RemoteDataTableColumn, RemoteDataTableQueryBuilderProps, SortingState } from './RemoteDataTable.types';
export { buildQuerySpecParams } from './query-spec-utils';
export type { OnChangeFn, PaginationState, QuerySpecField, QuerySpecFieldOption, QuerySpecFieldType, QuerySpecFilter, QuerySpecOp, RemoteDataTableColumn, RemoteDataTableColumnMeta, RemoteDataTableQueryBuilderProps, SortingState, } from './RemoteDataTable.types';
/**
 ...
 * ```
 */
export declare function RemoteDataTable<TData>({ data, columns, getRowId, pagination, onPaginationChange, sorting, onSortingChange, rowCount, loading, emptyMessage, pageSizeOptions, onRowClick, query, }: RemoteDataTableProps<TData>): import("react/jsx-runtime").JSX.Element;
