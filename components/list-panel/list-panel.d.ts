 ...
 */
export declare function ListPanel({ items, defaultSelectedItem, colBreakpoint, listMode, children, onSelectedItemChange, className, }: ListPanelProps): import("react/jsx-runtime").JSX.Element;
