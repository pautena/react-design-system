 ...
 */
export declare function DateRangePicker({ defaultValue, format: fmt, label, fullWidth, onValueChange, size, }: DateRangePickerProps): import("react/jsx-runtime").JSX.Element;
