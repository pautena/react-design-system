...
import { DrawerContentProps, DrawerNavigation, DrawerProps, DrawerProviderProps } from '../drawerx/drawer.types';
/**
 ...
 */
export default function DrawerLayout({ children, navigation, title, slots, slotsProps, ...rest }: DrawerLayoutProps): import("react/jsx-runtime").JSX.Element;
