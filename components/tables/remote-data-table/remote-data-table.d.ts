 ...
 * ```
 */
export declare function RemoteDataTable<TData>({ data, columns, getRowId, pagination, onPaginationChange, sorting, onSortingChange, rowCount, loading, emptyMessage, pageSizeOptions, onRowClick, query, className, }: RemoteDataTableProps<TData>): import("react/jsx-runtime").JSX.Element;
