import { BoxProps, BreadcrumbsProps, ButtonProps, ContainerProps, LinkProps, PropTypes, TabProps, TabsProps } from '@mui/material';
import { JSXElementConstructor, ReactElement } from '../../node_modules/react';
import { HeaderSubtitleProps, HeaderTitleProps } from './header-title';
