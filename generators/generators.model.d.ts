 ...
 */
export type ModelFieldTypes = "string" | "number" | "string[]" | "number[]" | "boolean" | "enum" | "multienum" | "date" | "time" | "datetime";
type Base = {
    id: string;
    description: string;
    name: string;
...
type SingleFields = StringField | NumberField | StringArrayField | NumberArrayField | BooleanField | EnumField | MultiEnumField | DateField | TimeField | DatetimeField;
