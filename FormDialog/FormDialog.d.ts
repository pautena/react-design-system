 ...
 */
export declare function FormDialog<T>({ open, title, loading, disabled, submitText, cancelText, children, onSubmit, onCancel, }: FormDialogProps<T>): import("react/jsx-runtime").JSX.Element;
